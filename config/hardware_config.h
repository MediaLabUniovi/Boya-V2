...
#define BAT_ADC_PULLUP_RES (10000.0)
#define BAT_ADC_PULLDOWN_RES (20000.0)
...
// =============================================================================
// PINES DE SENSORES ADICIONALES (BOYA MARÍTIMA)
// =============================================================================
// Estos pines pueden ser personalizados según el hardware específico

// Pin para DS18B20 (OneWire)
#ifndef DS18B20_DATA_PIN
#define DS18B20_DATA_PIN 15
#endif

// Pin para sensor de pH (ADC)
#ifndef PH_ANALOG_PIN
#define PH_ANALOG_PIN 25
#endif

// Pin para sensor de temperatura de electrónica (ADC)
#ifndef TEMP_ELEC_ANALOG_PIN
#define TEMP_ELEC_ANALOG_PIN 14
#endif

// Pin para control de alimentación de sensores (MOSFET)
#ifndef SENSOR_POWER_PIN
#define SENSOR_POWER_PIN 13
#endif

// Redefinir los pines específicos si no se han definido
#ifndef DS18B20_POWER_PIN
#define DS18B20_POWER_PIN SENSOR_POWER_PIN
#endif

#ifndef PH_POWER_PIN
#define PH_POWER_PIN SENSOR_POWER_PIN
#endif

#ifndef TEMP_ELEC_POWER_PIN
#define TEMP_ELEC_POWER_PIN SENSOR_POWER_PIN
#endif
